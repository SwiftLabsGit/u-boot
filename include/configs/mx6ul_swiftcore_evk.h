 ...
 *
 * Configuration settings for the Swift Labs i.MX6UL SWIFTCORE EVK board.
 *
 * SPDX-License-Identifier:	GPL-2.0+
 */
#ifndef __MX6UL_SWIFTCORE_EVK_CONFIG_H
#define __MX6UL_SWIFTCORE_EVK_CONFIG_H
...
#include "mx6ul_swiftcore_evk_android.h"
#endif
